 ...
 * Use when no interaction with the user is desired, will run with defaults
 * @package LCI\MODX\Console\Console\Helpers
 */
class VoidUserInteractionHandler implements UserInteractionHandler
{
